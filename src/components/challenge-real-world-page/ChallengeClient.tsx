...
export default function ChallengeClient({ data, iconSrc, slug }: any) {
        ...
        <>
          ...
          {showHome &&
            <Toast.Provider swipeDirection="right">
              <div className="min-h-screen relative z-10">
                <div className="pt-30 px-49 flex flex-row gap-13">
                  <div>
                ...
                <div className="px-44 mt-4 flex gap-6 min-h-[700px]">
                  <div className="w-4/10 flex flex-col gap-6">
                    <div className="bg-e rounded-lg p-4 px-6 border border-d-400 h-6/10 shadow-lg">
                      ...
                      <div className="text-lg text-black mt-4 text-justify font-h3">
                        {data.description}
                      </div>
                    </div>
